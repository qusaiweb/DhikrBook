...
import { Sun, Moon, Settings, Info, BookOpen, CheckCircle, RotateCcw, Clock, Star, X, Plus, Minus, Type } from 'lucide-react';
...
const adhkarData = [
  ...
  },
  {
    ...
    target: 1,
    category: 'أولاً: ما يُقال مرة واحدة',
    textMorning: 'اللَّهُمَّ أَنْتَ رَبِّي لَا إِلَهَ إِلَّا أَنْتَ، خَلَقْتَنِي وَأَنا عَبْدُكَ، وَأَنا عَلَى عَهْدِكَ وَوَعْدِكَ ما اسْتَطَعْت، أَعوذُ بِكَ مِنْ شَرِ ما صَنَعْت، أبوءُ لَكَ بِنِعْمَتِكَ عَلَيَّ وَأَبوءُ بِذَنْبي فَاغْفِرْ لِي فَإِنَّهُ لَا يَغْفِرُ الذُّنوبَ إِلَّا أَنْتَ.',
  ...
  },
  {
    ...
    target: 1,
    category: 'أولاً: ما يُقال مرة واحدة',
    textMorning: 'أَصْبَحْنا وَأَصْبَحَ المُلْكُ لله، وَالحَمدُ لله، لا إلهَ إِلَّا اللهُ وَحدَهُ لا شَرِيكَ له، له الملك وله الحمد، وهُوَ على كلّ شَيءٍ قدير، رَبِّ أَسْأَلُكَ خَيرَ ما في هذا اليوم وَخَيرَ ما بَعْدَه، وَأَعُوذُ بِكَ مِنْ شَرِ ما في هذا اليوم وَشَرِّ ما بَعْدَه، رَبِّ أَعوذُ بِكَ مِنَ الْكَسَلِ وَسوءِ الْكِبَر، رَبِّ أَعوذُ بِكَ مِنْ عَذابٍ في النَّارِ وَعَذابٍ في القَبْر.',
    textEvening: 'أَمْسَيْنَا وَأَمْسَى المُلْكُ لله، وَالحَمدُ لله، لا إلهَ إِلَّا اللهُ وَحدَهُ لا شَرِيكَ له، له الملك وله الحمد، وهُوَ على كلّ شَيءٍ قدير، رَبِّ أَسْأَلُكَ خَيْرَ ما في هذه الليلة وَخَيْرَ ما بَعْدَها، وَأَعوذُ بِكَ مِنْ شَرِ ما في هذه الليلة وَشَرِ ما بَعْدَها، رَبِّ أَعوذُ بِكَ مِنَ الْكَسَلِ وَسوءِ الْكِبَر، رَبِّ أَعوذُ بِكَ مِنْ عَذابٍ في النَّارِ وَعَذابٍ في القَبْر.',
  ...
  },
  {
    ...
    target: 1,
    category: 'أولاً: ما يُقال مرة واحدة',
    textMorning: 'أَصْبَحْنا وَأَصْبَحَ المُلكُ للهِ رَبِّ العالمين، اللَّهُمَّ إِنِّي أَسْأَلُكَ خَيْرَ هذا اليَوْم، فَتْحَهُ، وَنَصْرَهُ، وَنُورَهُ وَبَرَكَتَهُ، وَهُداهُ، وَأَعوذُ بِكَ مِنْ شَرِّ مَا فِيهِ وَشَرِّ ما بَعْدَه.',
    textEvening: 'أَمْسَيْنَا وَأَمْسَى الْمُلْكُ للهِ رَبِّ الْعَالَمَيْنِ، اللَّهُمَّ إِنِّي أَسْأَلُكَ خَيْرَ هَذَهُ اللَّيْلَةِ فَتْحَهَا، ونَصْرَهَا، ونُوْرَهَا وَبَرَكَتِهَا، وَهُدَاهَا، وَأَعُوذُ بِكَ مِنْ شَرِّ مَا فِيها وَشَرَّ مَا بَعْدَهَا.',
  ...
  },
  {
    ...
    target: 1,
    category: 'أولاً: ما يُقال مرة واحدة',
    textMorning: 'اللَّهُمَّ بِكَ أَصْبَحْنا وبك أَمْسَينا، وَبِكَ نَحْيا، وَبِكَ نَمُوتُ، وَإِلَيْكَ النُّشُور.',
    textEvening: 'اللَّهُمَّ بِكَ أَمْسَيْنَا، وَبِكَ أَصْبَحْنَا، وَبِكَ نَحْيا وَبِكَ نَمُوتُ وَإِلَيْكَ المصير.',
  ...
  },
  {
    ...
    target: 1,
    category: 'أولاً: ما يُقال مرة واحدة',
    textMorning: 'اللَّهُمَّ ما أَصْبَحَ بي مِنْ نِعْمَةٍ أَو بِأَحَدٍ مِنْ خَلْقِكَ، فَمِنْكَ وَحْدَكَ لا شريكَ لك، فَلَكَ الْحَمْدُ وَلَكَ الشُّكْر.',
    textEvening: 'اللَّهُمَّ ما أَمْسَى بي مِنْ نِعْمَةٍ أَو بِأَحَدٍ مِنْ خَلْقِكَ، فَمِنْكَ وَحْدَكَ لا شريكَ لك، فَلَكَ الْحَمْدُ وَلَكَ الشُّكْر.',
  ...
  },
  {
    ...
    target: 1,
    category: 'أولاً: ما يُقال مرة واحدة',
    textMorning: 'اللهُمَّ إِنِّي أَسْأَلُكَ العفو والعافية في الدُّنْيا وَالآخِرَةِ، اللَّهُمَّ إِنِّي أَسْأَلُكَ العَفْوَ والعافية في ديني وَدُنْيايَ وَأهْلي وَمالي، اللّهُمَّ اسْتُرْ عَوْراتي وَآمِنْ رَوْعاتـي، اللّهُمَّ احْفَظْني مِن بَيْنِ يَدَيَّ وَمِن خَلْفِي وَعَنِ يميني وَعَن شمالي، وَمِن فَوْقي، وَأَعوذُ بِعَظَمَتِكَ أَن أُغْتَالَ مِن تَحْتِي.',
  ...
  },
  {
    ...
    target: 1,
    category: 'أولاً: ما يُقال مرة واحدة',
    textMorning: 'اللَّهُمَّ فَاطِرَ السَّماواتِ وَالْأَرْضِ، عالِمَ الغَيْبِ وَالشَّهَادَةِ، رَبَ كلِّ شَيْءٍ وَمَليكَه، أَشْهَدُ أَنْ لا إِلهَ إِلَّا أَنْت، أَعوذُ بِكَ مِن شَرِ نَفْسِي وَمِن شَرِ الشَّيْطَانِ وَشِرْكِه، وَأَنْ أَقْتَرِفَ عَلَى نَفْسي سوءاً أَوْ أَجُرَّهُ إِلَى مُسْلِم.',
  ...
  },
  {
    ...
    target: 1,
    category: 'أولاً: ما يُقال مرة واحدة',
    textMorning: 'يا حَيُّ يَا قَيُّومُ بِرَحْمَتِكَ أَسْتَغيث، أَصْلِحْ لِي شَأْنِي كُلَّه وَلَا تَكِلني إِلَى نَفْسِي طَرْفَةَ عَين.',
  ...
  },
  {
    ...
    target: 3,
    category: 'ثانياً: ما يُقال ثلاث مرات',
    textMorning: 'بِسمِ اللهِ الذي لا يَضُرُّ مَعَ اسمِهِ شَيْءٌ في الأَرْضِ وَلا في السَّمَاءِ وَهوَ السميع العليم.',
  ...
  },
  {
    ...
    target: 3,
    category: 'ثانياً: ما يُقال ثلاث مرات',
    textMorning: 'رَضِيتُ بِاللهِ رَبّا، وَبِالإِسْلامِ دينا، وَبِمُحَمَّدٍ ﷺ نَبِيّاً.',
  ...
  },
  {
    ...
    target: 3,
    category: 'ثانياً: ما يُقال ثلاث مرات',
    textMorning: 'اللهم عافني في بدني، اللهُمَّ عافني في سمعي، اللهم عافني في بَصَري، لا إلهَ إِلَّا أَنْتَ، اللَّهُمَّ إِنِّي أَعوذُ بِكَ مِنَ الْكُفْرِ وَالفَقْرِ، وَأَعُوذُ بِكَ مِنْ عَذَابِ القَبْر، لا إلهَ إِلَّا أَنْت.',
  ...
  },
  {
    ...
    target: 3,
    category: 'ثانياً: ما يُقال ثلاث مرات',
    textMorning: 'أعوذُ بكلماتِ الله التَّامَّاتِ مِنْ شَرِّ مَا خَلَق.',
    textEvening: 'أعوذُ بكلماتِ الله التَّامَّاتِ مِنْ شَرِّ مَا خَلَق.',
  ...
  },
  {
    ...
    textMorning: 'اللهُمَّ إِنِّي أَصْبَحْتُ أُشْهِدُكَ وَأُشْهِدُ حَمَلَةَ عَرْشِكَ، وَمَلائِكَتَكَ وَجَميعَ خَلْقِكَ، أَنَّكَ أَنْتَ اللهُ لا إلهَ إِلَّا أَنْتَ، وَحْدَكَ لا شَرِيكَ لَكَ، وَأَنَّ مُحَمَّداً عَبْدُكَ وَرَسولُك.',
    textEvening: 'اللهُمَّ إِنِّي أَمْسَيْتُ أُشْهِدُكَ وَأُشْهِدُ حَمَلَةَ عَرْشِكَ، وَمَلائِكَتَكَ وَجَميعَ خَلْقِكَ، أَنَّكَ أَنْتَ اللهُ لا إلهَ إِلَّا أَنْتَ، وَحْدَكَ لا شَرِيكَ لَكَ، وَأَنَّ مُحَمَّداً عَبْدُكَ وَرَسولُك.',
  ...
  },
  {
    ...
    textMorning: 'حَسْبِيَ اللهُ لا إِلَهَ إِلَّا هُوَ عَلَيْهِ تَوَكَّلتُ وَهُوَ رَبُّ العَرْشِ العَظيم.',
  ...
  },
  {
    ...
    textMorning: 'لا إلهَ إِلَّا اللهُ وَحْدَهُ لا شَريكَ لهُ، لهُ المُلْكُ ولهُ الحَمْدُ وهُوَ على كُلِّ شَيْءٍ قدير.',
  ...
  },
  {
    ...
    textMorning: 'سُبْحَانَ اللَّهِ وَبِحَمْدِهِ.',
    takhreej: 'رواه مسلم.',
...
export default function App() {
  ...
  const [fontSizeIndex, setFontSizeIndex] = useState(2); // 2 هو الافتراضي
  const [progress, setProgress] = useState({});

  // دالة تشغيل الاهتزاز (Haptic Feedback)
  ...
  // استرجاع البيانات وتحديد الوقت تلقائياً عند فتح التطبيق
  useEffect(() => {
    ...
    // تحديد أذكار الصباح أو المساء بناءً على الوقت (من 3 فجراً إلى 3 عصراً يعتبر صباح)
  ...
  // حفظ التغييرات تلقائياً (التقدم، الوضع الليلي، حجم الخط)
  useEffect(() => {
  ...
  // فلترة الأذكار بناءً على الوقت (صباح/مساء)
  const filteredAdhkar = useMemo(() => {
    return adhkarData.filter(dhikr => {
      if (activeTab === 'morning' && dhikr.eveningOnly) return false;
      if (activeTab === 'evening' && dhikr.morningOnly) return false;
      return true;
    });
  }, [activeTab]);

  // تحديث عداد الذكر مع الاهتزاز والانتقال التلقائي
  const handleDhikrClick = (id, target) => {
    setProgress((prev) => {
      ...
      if (current < target) {
        ...
        // إذا اكتمل العدد
        if (newCount === target) {
          triggerVibration([100, 50, 100]); // اهتزاز مميز للاكتمال
          
          // الانتقال التلقائي للذكر التالي بعد تأخير بسيط
          setTimeout(() => {
            const currentIndex = filteredAdhkar.findIndex(d => d.id === id);
            if (currentIndex !== -1 && currentIndex < filteredAdhkar.length - 1) {
              const nextId = filteredAdhkar[currentIndex + 1].id;
              const nextElement = document.getElementById(`dhikr-${nextId}`);
              if (nextElement) {
                // التمرير السلس ووضع العنصر في منتصف الشاشة
                nextElement.scrollIntoView({ behavior: 'smooth', block: 'center' });
              }
            }
          }, 600); // 600 مللي ثانية تأخير ليرى المستخدم اكتمال العداد
          
        } else {
          triggerVibration(50); // اهتزاز خفيف للضغطة العادية
        }
  ...
  return (
    <div dir="rtl" className={`min-h-screen font-cairo transition-colors duration-300 ${isDarkMode ? 'dark bg-slate-900 text-slate-100' : 'bg-slate-50 text-slate-900'}`}>
      ...
      <header className="sticky top-0 z-40 shadow-md bg-teal-600 dark:bg-slate-800 text-white">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          <div className="flex items-center space-x-3 space-x-reverse">
            ...
            <h1 className="text-xl md:text-2xl font-bold tracking-wide">أذكار الصباح والمساء</h1>
          </div>
        ...
        <div className="flex border-t border-teal-500 dark:border-slate-700">
          <button 
            ...
            className={`flex-1 py-3 text-center font-bold text-lg md:text-xl transition-colors ${activeTab === 'morning' ? 'bg-teal-700 dark:bg-slate-700 text-white border-b-4 border-yellow-400' : 'text-teal-100 hover:bg-teal-500 dark:hover:bg-slate-600'}`}
          >
            أذكار الصباح
          </button>
          <button 
            onClick={() => setActiveTab('evening')}
            className={`flex-1 py-3 text-center font-bold text-lg md:text-xl transition-colors ${activeTab === 'evening' ? 'bg-teal-700 dark:bg-slate-700 text-white border-b-4 border-indigo-400' : 'text-teal-100 hover:bg-teal-500 dark:hover:bg-slate-600'}`}
          >
            أذكار المساء
          </button>
        </div>
      ...
      <main className="container mx-auto px-4 py-6 md:py-8 max-w-4xl">
        ...
        {/* --- تنبيه أوقات الأذكار --- */}
        <div className="mb-8 p-5 bg-teal-50 dark:bg-slate-800 rounded-2xl shadow-sm border border-teal-100 dark:border-slate-700">
          <div className="flex items-start gap-3">
            <Clock className="w-6 h-6 text-teal-600 dark:text-teal-400 shrink-0 mt-1" />
            <div>
              <h2 className="text-lg font-bold text-teal-800 dark:text-teal-300 mb-2">وقت الأذكار المفضل</h2>
              <p className="text-slate-700 dark:text-slate-300 leading-relaxed font-medium">
                <span className="text-teal-700 dark:text-teal-400 font-bold">الصباح:</span> ما بين طلوع الفجر إلى شروق الشمس.<br/>
                <span className="text-teal-700 dark:text-teal-400 font-bold">المساء:</span> ما بين العصر إلى غروب الشمس.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-6 md:space-y-8">
          {filteredAdhkar.map((dhikr) => {
            ...
            // تحديد لون زر العداد بناءً على نسبة التقدم
            ...
            if (isCompleted) {
              ...
              counterBgClass = "bg-emerald-500 hover:bg-emerald-600 dark:bg-emerald-600 dark:hover:bg-emerald-500 text-white shadow-lg";
            } else if (percentage > 0.3) {
              counterBgClass = "bg-teal-500 hover:bg-teal-600 dark:bg-teal-600 dark:hover:bg-teal-500 text-white shadow-lg";
            }

            return (
              <div 
                key={dhikr.id} 
                id={`dhikr-${dhikr.id}`} // إضافة ID ليتم التمرير إليه تلقائياً
              ...
              >
                {/* شريط التصنيف */}
                <div className="bg-slate-100 dark:bg-slate-700/40 py-3 px-6 text-sm md:text-base font-bold text-teal-700 dark:text-teal-300 border-b border-slate-200 dark:border-slate-700">
                  {dhikr.category}
                </div>

                <div className="p-6 md:p-8">
                  {/* نص الذكر مع حجم الخط الديناميكي */}
                  ...
                  {/* منطقة التفاعل: زر العداد وزر التصفير الفردي */}
                  <div className="flex flex-row-reverse gap-3 items-stretch justify-center w-full md:w-5/6 mx-auto">
                    ...
                    {/* زر العداد التجاوبي (تمت زيادة طوله وحجم النص فيه) */}
                    <button
                      onClick={() => handleDhikrClick(dhikr.id, dhikr.target)}
                      disabled={isCompleted}
                      className={`flex-1 relative overflow-hidden py-8 md:py-10 rounded-3xl font-bold text-2xl md:text-4xl transition-all duration-300 flex justify-center items-center gap-4 active:scale-95 min-h-[100px] md:min-h-[120px] ${counterBgClass}`}
                    >
                      {isCompleted ? (
                        <>
                      ...
                      {/* شريط تقدم خلفي يظهر للون المتبقي من الخلفية */}
      ...
      <footer className="bg-slate-200 dark:bg-slate-950 py-8 text-center text-slate-600 dark:text-slate-400 mt-12 border-t border-slate-300 dark:border-slate-800">
        <p className="font-bold text-lg">جمع وترتيب: د. مطلق جاسر مطلق الجاسر</p>
        <p className="text-sm mt-2 opacity-80">تم التصميم بناءً على رسالة: المختصر في أذكار الصباح والمساء</p>
      </footer>
